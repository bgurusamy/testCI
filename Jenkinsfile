    ...
    stages {
        ...
        stage('Notification') {
            steps {
             ...
             slackSend channel: '#jenkins-latest', color: 'good', message: 'Slack Message',baseUrl:'https://cim.slack.com/services/hooks/jenkins-ci/',teamDomain: 'cim.slack.com', token: 'RNywdyYpxF6RwN9dsqW83I7H'
